...
class WebSocketHandler:
    ...
    def __init__(
        ...
        noise_gate_bot_sustain_ms: float = 100,
        ...
        Args:
            ...
            noise_gate_bot_sustain_ms: While the bot speaks, consecutive
                above-threshold audio must SUSTAIN this long before the gate
                opens (echo transients cross the threshold; real barge-in
                sustains). 0 restores the instant-open behavior.
        ...
        self._noise_gate_bot_sustain_ms = noise_gate_bot_sustain_ms
    ...
    def build_pipeline(
        ...
        noise_gate = NoiseGate(
            ...
            bot_sustain_ms=self._noise_gate_bot_sustain_ms,
