"""Unit tests for the pure transcript accumulator (no SDK / no network)."""
from listen_bridge.transcript import TranscriptAccumulator, _fmt_ts, words_to_runs
...
def test_fmt_ts():
    ...
    assert _fmt_ts(-5) == "00:00:00"  # clamp
